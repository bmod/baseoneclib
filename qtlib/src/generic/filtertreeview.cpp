...
_FilterTreeView::_FilterTreeView() : QTreeView() {
    setAcceptDrops(true);
}

void _FilterTreeView::dragEnterEvent(QDragEnterEvent* event) {
    QAbstractItemView::dragEnterEvent(event);
}

void _FilterTreeView::dragMoveEvent(QDragMoveEvent* event) {
...
void _FilterTreeView::dropEvent(QDropEvent* event) {
